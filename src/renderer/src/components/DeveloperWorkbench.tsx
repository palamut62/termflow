...
export default function DeveloperWorkbench({ onClose }: { onClose: () => void }): React.JSX.Element {
  ...
  return <div className="modal-overlay" onMouseDown={onClose}><div className="modal workbench" onMouseDown={(e) => e.stopPropagation()}>
