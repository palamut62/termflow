...
const topics: HelpTopic[] = [
  ...
  { id: 'manual', category: 'Layout', title: 'Manual mode', summary: 'Use free positioning when you want to arrange terminals yourself instead of dense tiling.', steps: ['Open Layout in the header.', 'Choose Manual for free movement.', 'Pan and zoom are enabled only in this canvas-oriented mode.'] },
