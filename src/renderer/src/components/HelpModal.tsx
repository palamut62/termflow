...
const topics: HelpTopic[] = [
  ...
  { id: 'windows', category: 'Windows', title: 'Windows and the tab strip', summary: 'Every terminal lives in a window; the selected window fills the whole work area, like a tmux window.', steps: ['Use New Terminal to open a new window.', 'Click a tab in the strip above the terminal to switch windows.', 'Press Ctrl+Tab for the next window, Ctrl+Shift+Tab for the previous one.'], notes: ['Only the selected window is rendered; the others stay in the background with their processes running.', 'The active window is highlighted in the sidebar and the status bar.'] },
