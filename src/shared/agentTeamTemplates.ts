import type { StartTeamTemplate } from './types'

export const AGENT_TEAM_TEMPLATES: StartTeamTemplate[] = [
  {
...
export function getAgentTeamTemplate(id?: string): StartTeamTemplate | undefined {
