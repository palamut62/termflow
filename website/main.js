/* ============================================================
   ...
   1) GitHub Releases (recommended — no Vercel size limit):
      ...
      https://github.com/palamut62/termflow/releases/download/v0.3.0/TermFlow-0.3.0-x64.exe
   2) Self-host on Vercel: drop the files in website/public/download/
      and use "./download/TermFlow-0.3.0-x64.exe"
   ============================================================ */
const DOWNLOADS = {
  installer: 'https://zomlia6emkmpi3hi.public.blob.vercel-storage.com/downloads/TermFlow-0.3.0-x64.exe'
}
